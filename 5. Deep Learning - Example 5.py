...
"Example 5: multiple inputs - multiple neurons hidden layers - multiple outputs"
...
# =============================================================================
y = np.array([[5, 6, 7, 8]])    # Output layer, arbitrary number of neurons
...
class Neural_Network(object):
    ...
    def costFunction(self, y):
        "return cost function value for multiple output"
        J = 0.5*((self.Z[-1] - y)**2)
        return J.sum()   # sum of the elements in vector J
...
NN = Neural_Network([2,4,3,2,4])  # number of neurons in input, hidden and output layer(s)
NN.setPar([0.7, 0.55, 0.5, 0.8, 0.1, 0.9, 0.25, 0.3,\
           0.4, 0.2, 0.9, 0.5, 0.7, 0.5, 0.2, 0.7, 0.5, 0.1, 0.2, 0.5,\
           0.1, 0.4, 0.25, 0.4, 0.4, 0.65,\
           0.8, 0.4, 0.5, 0.25, 0.45, 0.25, 0.5, 0.15]) # set specific initial weights
NN.trainNetwork(0.002, 25)  
